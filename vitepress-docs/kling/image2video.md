...
::: tip 推荐使用 Omni 端点
对于 `kling-v3-0` 及 `kling-video-o1` 模型，建议使用 [Omni 全能视频](/kling/omni-video) 端点，支持更丰富的功能（多镜头、视频编辑、原生音频等）。本端点主要适用于 `kling-v1` / `kling-v1-5` / `kling-v1-6` 等旧版模型。
:::
...
| 参数名 | 类型 | 必填 | 默认值 | 说明 | 示例 |
|--------|------|------|--------|------|------|
| model | string | 是 | - | 使用的模型 ID。支持 `kling-v1`, `kling-v1-5`, `kling-v1-6`, `kling-v2-1`, `kling-v2-5-turbo`, `kling-v2-6`, `kling-v3-0` 等 | `kling-v1` |
