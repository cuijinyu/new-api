...
|------|------|---------------|------------|----------|----------|
| `kling-v3-omni` | Video 3.0，最新版本 | 3-15s | ✅ | ✅ | ✅ |
...
| 参数名 | 类型 | 必填 | 默认值 | 说明 | 示例 |
|--------|------|------|--------|------|------|
| model | string | 是 | - | 使用的模型 ID | `kling-v3-omni` |
...
| refer_type | string | 参考类型：`feature` (特征参考) 或 `base` (视频编辑，仅 `kling-v3-omni` 支持) |
...
|------|------|---------|--------|-----------|
| `kling-v3-omni` | Std | 按秒计费 | ×1.5 | ×1.5 |
| `kling-v3-omni` | Pro | 按秒计费 ×1.333 | ×1.5 | ×1.5 |
