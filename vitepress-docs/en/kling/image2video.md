...
For `kling-v3-0` and `kling-video-o1` models, we recommend using the [Omni Video](/en/kling/omni-video) endpoint, which supports richer features (multi-shot, video editing, native audio, etc.). This endpoint is primarily for legacy models such as `kling-v1` / `kling-v1-5` / `kling-v1-6`.
:::
...
|-----------|------|----------|---------|-------------|---------|
| model | string | Yes | - | The model ID. Supports `kling-v1`, `kling-v1-5`, `kling-v1-6`, `kling-v2-1`, `kling-v2-5-turbo`, `kling-v2-6`, `kling-v3-0`, etc. | `kling-v1` |
