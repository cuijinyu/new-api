...
| `kling-v3` | Kling V3.0 Text/Image to Video | text2video / image2video |
| `kling-v3-omni` | Kling V3.0 Omni Video (Latest) | omni-video |
...
`kling-v3-omni` provides the following new capabilities via the [Omni Video](/en/kling/omni-video) endpoint:
