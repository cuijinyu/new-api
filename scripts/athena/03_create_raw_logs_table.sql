-- ============================================================
-- Step 3: 创建 Raw 日志表（完整请求/响应，用于深度排查和交叉对账）
--
-- S3 路径格式: s3://ezmodel-log/llm-raw-logs/2026/03/29/15/xxx.ndjson.gz
-- ============================================================
CREATE EXTERNAL TABLE IF NOT EXISTS ezmodel_logs.raw_logs (
...
LOCATION 's3://ezmodel-log/llm-raw-logs/'
TBLPROPERTIES (
  'classification'                        = 'json',
  ...
  'storage.location.template'             = 's3://ezmodel-log/llm-raw-logs/${year}/${month}/${day}/${hour}/'
);
