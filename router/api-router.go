...
func SetApiRouter(router *gin.Engine) {
	...
	anonymousRequestBodyLimit := middleware.AnonymousRequestBodyLimit()
	{
		...
		channelRoute.Use(middleware.AdminAuth())
		{
			...
			channelRoute.GET("/fingerprint", controller.FingerprintAllChannels)
			channelRoute.GET("/fingerprint/:id", controller.FingerprintChannel)
		...
		{
			openRouterInspectionRoute.POST("/prices/fetch", controller.OpenRouterInspectionFetchPrices)
			openRouterInspectionRoute.POST("/run", controller.OpenRouterInspectionRun)
			openRouterInspectionRoute.GET("/runs", controller.OpenRouterInspectionGetRuns)
			openRouterInspectionRoute.GET("/items", controller.OpenRouterInspectionGetItems)
			openRouterInspectionRoute.GET("/summary", controller.OpenRouterInspectionSummary)
		}
		priceInspectionRoute := apiRouter.Group("/price_inspection")
		priceInspectionRoute.Use(middleware.AdminAuth())
		{
			priceInspectionRoute.GET("/sources", controller.PriceInspectionGetSources)
			priceInspectionRoute.POST("/sources/:provider/fetch", controller.PriceInspectionFetchSourcePrices)
			priceInspectionRoute.GET("/snapshots", controller.PriceInspectionGetSnapshots)
			priceInspectionRoute.POST("/snapshots", controller.PriceInspectionCreateSnapshot)
			priceInspectionRoute.POST("/snapshots/batch", controller.PriceInspectionCreateSnapshots)
			priceInspectionRoute.DELETE("/snapshots/:id", controller.PriceInspectionDeleteSnapshot)
			priceInspectionRoute.POST("/run", controller.PriceInspectionRun)
			priceInspectionRoute.POST("/coverage/generate", controller.PriceInspectionGenerateCoverage)
			priceInspectionRoute.GET("/coverage", controller.PriceInspectionGetCoverage)
			priceInspectionRoute.GET("/coverage/export", controller.PriceInspectionExportCoverage)
			priceInspectionRoute.GET("/coverage/summary", controller.PriceInspectionCoverageSummary)
			priceInspectionRoute.GET("/runs", controller.PriceInspectionGetRuns)
			priceInspectionRoute.GET("/items", controller.PriceInspectionGetItems)
			priceInspectionRoute.GET("/items/export", controller.PriceInspectionExportItems)
			priceInspectionRoute.GET("/issues", controller.PriceInspectionGetIssues)
			priceInspectionRoute.GET("/issues/export", controller.PriceInspectionExportIssues)
			priceInspectionRoute.PUT("/issues/resolution", controller.PriceInspectionUpdateIssueResolution)
			priceInspectionRoute.GET("/summary", controller.PriceInspectionSummary)
			priceInspectionRoute.GET("/model_mappings", controller.PriceInspectionGetModelMappings)
			priceInspectionRoute.POST("/model_mappings", controller.PriceInspectionCreateModelMapping)
			priceInspectionRoute.PUT("/model_mappings/:id", controller.PriceInspectionUpdateModelMapping)
			priceInspectionRoute.POST("/model_mappings/suggest", controller.PriceInspectionSuggestModelMappings)
		}
