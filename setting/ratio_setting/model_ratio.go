...
var defaultModelPrice = map[string]float64{
	...
	"dreamina-seedance-2-0-ep":              7.0,
	"dreamina-seedance-2-0-fast-260128":     5.6,
	"doubao-seedance-2-0-260128":            7.0,
	"doubao-seedance-2-0-fast-260128":       5.6,
	"service-inference-seedance-2-0-260128": 7.0,
	"service-inference-seedance-2-0-ep":     7.0,
	"service-inference-seedance-2-0-fast-260128": 5.6,
	// 可灵特殊功能专用 ModelPrice
	// 这些功能的官方价格与普通视频不同，使用独立的计费模型名
	// ModelPrice = 官方价格/秒 × 0.14
	"kling-multi-elements": 0.084, // 多模态视频编辑: 官方 Std 0.6元/秒 (0.6×0.14=0.084)
...
func getHardcodedCompletionModelRatio(name string) (float64, bool) {
	...
	if strings.HasPrefix(name, "gpt-") {
		...
		// gpt-5.5: $30 output / $5 input = 6
		if strings.HasPrefix(name, "gpt-5.5") {
			return 6, true
		}
		// gpt-5.4: $15 output / $2.5 input = 6
